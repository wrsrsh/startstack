...
// Memoize the main Breadcrumb component
const Breadcrumb = React.memo(
  React.forwardRef<HTMLElement, React.ComponentPropsWithoutRef<"nav"> & { separator?: React.ReactNode }>(
    ({ ...props }, ref) => <nav ref={ref} aria-label="breadcrumb" {...props} />
  )
);
Breadcrumb.displayName = "Breadcrumb";

// Memoize BreadcrumbList
...
// Memoize BreadcrumbLink
const BreadcrumbLink = React.memo(
  React.forwardRef<HTMLAnchorElement, React.ComponentPropsWithoutRef<"a"> & { asChild?: boolean }>(
